    ...
    <div className="collapse navbar-collapse text-center" id="navbarNav">
      <ul className="navbar-nav ml-auto">
        <li className="nav-item mx-auto my-auto">
          <Link href="/episodes">
            <a className="nav-link" style={{ color: fontColor }}>Episodios</a>
          </Link>
        </li>
        <li className="nav-item active my-auto mx-auto">
          <Link href="/about">
            <a className="nav-link" style={{ color: fontColor }}>Info</a>
          </Link>
        </li>
        <li className="nav-item my-auto mx-auto">
          <Link href="/contact">
            <a className="nav-link" style={{ color: fontColor }}>Contacto</a>
          </Link>
        </li>
